					...
					<div class="col-sm-4">
						<form class="d-flex" method="GET" action="">
							...
							<button class="btn text-white" type="submit"
								style="background-color:rgb(30, 18, 11);">Search</button>
						</form>
					</div>
				</div>
			</div>
								...
								<div class="row">
									<div class="col-4 text-start py-3">
										...
										<button type="button" class="btn text-white" data-bs-toggle="modal"
											data-bs-target="#myModal" style="background-color:rgb(30, 18, 11);">+ Data
											Produk</button>
										<button type="button" class="btn btn-warning" data-bs-toggle="modal"
											data-bs-target="#tambahstok">+ Stok</button>
									</div>
